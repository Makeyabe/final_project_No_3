...
public class UpdateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                setResult(RESULT_OK, intent); // Set result to notify DetailActivity for data update
                finish();
            }
        });
    }
    ...
    public void saveData(){
        ...
        if(uri != null) { // If new image is selected
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    uriTask.addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            updateData(); // Call updateData() after getting the image URL
                            dialog.dismiss();
                        }
        ...
        } else { // If no new image is selected, use old image URL
